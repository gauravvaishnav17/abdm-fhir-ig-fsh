Instance: InsurancePlan-example-01
InstanceOf: InsurancePlan
Title: "InsurancePlan/example-01"
Description: "InsurancePlan/example-01"
Usage: #example
* id = "example-01"
* meta.versionId = "1"
* extension[0].extension[0].url = "category"
* extension[=].extension[=].valueCodeableConcept = SupportingInfoCategory#POI "Proof of identity"
* extension[=].extension[+].url = "code"
* extension[=].extension[=].valueCodeableConcept = IdentifierType#ADN "Adhaar number"
...
* extension[=].extension[=].valueCodeableConcept = SupportingInfoCategory#POA "Proof of address"
* extension[=].extension[+].url = "code"
* extension[=].extension[=].valueCodeableConcept = $v2-0203#PPN "Passport number"
* extension[=].url = "https://nrces.in/ndhm/fhir/r4/StructureDefinition/Claim-SupportingInfoRequirement"
* extension[+].extension[0].url = "category"
* extension[=].extension[=].valueCodeableConcept = $sct#277011002 "Pre-existing disease in renal transplant"
...
* extension[+].extension[0].url = "category"
* extension[=].extension[=].valueCodeableConcept.text = "Specified disease"
* extension[=].extension[+].url = "statement"
...
* status = #active
* type = InsurancePlanType#01 "Hospitalisation Indemnity Policy"
* name = "Active Assure Silver"
* period.start = "2023-09-10"
* period.end = "2024-09-10"
* ownedBy = Reference(Organization/example-02)
* administeredBy = Reference(Organization/example-02)
...
* plan[=].type = PlanType#01 "Individual"
