Instance: ChargeItem-Medication-Sulfalene-example-01
InstanceOf: ChargeItem
Title: "ChargeItem/Medication-Sulfalene-example-01"
Description: "ChargeItem/Medication-Sulfalene-example-01"
Usage: #example
...
* productReference = Reference(Medication/example-02)
