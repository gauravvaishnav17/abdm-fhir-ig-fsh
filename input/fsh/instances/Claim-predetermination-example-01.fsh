Instance: Claim-predetermination-example-01
InstanceOf: Claim
Title: "Claim/Claim-predetermination-example-01"
Description: "Claim/Claim-predetermination-example-01"
Usage: #example
* id = "Claim-predetermination-example-01"
