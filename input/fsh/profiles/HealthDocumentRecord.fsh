...
* ^meta.versionId = "2"
* ^meta.lastUpdated = "2025-03-17T06:33:24.0839617+00:00"
* ^version = "6.0.0"
* ^status = #draft
...
* type.coding.code 1..
* type.coding.code = #419891008 (exactly)
* type.coding.display 1..
* type.coding.display = "Record artifact" (exactly)
* type.text MS
* subject 1.. MS
...
* section 1..1 MS
* section ^short = "The section contains references to documents that represent unstructured historical health records uploaded by patients. These documents can include medical reports, discharge summaries, diagnostic images, and any other relevant health records."
...
* section.code.coding.code = #419891008 (exactly)
* section.code.coding.display 1..
* section.code.coding.display = "Record artifact" (exactly)
* section.code.text MS
* section.author only Reference(Device or RelatedPerson or Organization or Practitioner or PractitionerRole or Organization or Patient)
* section.entry 1.. MS
* section.entry only Reference(DocumentReference)
